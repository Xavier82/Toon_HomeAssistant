...
App {
    ...
    property string homeAssistantSwitch6 : ""
    property string homeAssistantSwitch7 : ""
    property string homeAssistantSwitch8 : ""
    property string homeAssistantSwitch9 : ""
    property string homeAssistantSwitch10 : ""
    property string homeAssistantSwitch11 : ""
    property string homeAssistantSwitch12 : ""
    property string homeAssistantSwitch13 : ""
    property string homeAssistantSwitch14 : ""
    property string homeAssistantSwitch15 : ""
    property string homeAssistantSwitch16 : ""
    property string homeAssistantSwitch17 : ""
    property string homeAssistantSwitch18 : ""
    ...
    property variant homeAssistantSwitch6Info : []
    property variant homeAssistantSwitch7Info : []
    property variant homeAssistantSwitch8Info : []
    property variant homeAssistantSwitch9Info : []
    property variant homeAssistantSwitch10Info : []
    property variant homeAssistantSwitch11Info : []
    property variant homeAssistantSwitch12Info : []
    property variant homeAssistantSwitch13Info : []
    property variant homeAssistantSwitch14Info : []
    property variant homeAssistantSwitch15Info : []
    property variant homeAssistantSwitch16Info : []
    property variant homeAssistantSwitch17Info : []
    property variant homeAssistantSwitch18Info : []
    ...
    function saveHomeAssistantSwitchesJson() {
        var homeAssistantSwitchesJson = {
            ...
            "Switch6" : homeAssistantSwitch6,
            "Switch7" : homeAssistantSwitch7,
            "Switch8" : homeAssistantSwitch8,
            "Switch9" : homeAssistantSwitch9,
            "Switch10" : homeAssistantSwitch10,
            "Switch11" : homeAssistantSwitch11,
            "Switch12" : homeAssistantSwitch12,
            "Switch13" : homeAssistantSwitch13,
            "Switch14" : homeAssistantSwitch14,
            "Switch15" : homeAssistantSwitch15,
            "Switch16" : homeAssistantSwitch16,
            "Switch17" : homeAssistantSwitch17,
            "Switch18" : homeAssistantSwitch18,
        }
    ...
    function getSwitchInfo() {
        if (connected) {
            ...
            getHomeAssistant(homeAssistantSwitch6, function(data) {
                if (data) {
                    homeAssistantSwitch6Info = data;
                    homeAssistantScreen.switch6R.switch6.state = JSON.parse(homeAssistantSwitch6Info)['state'];
                } else {
                    homeAssistantSwitch6Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch7, function(data) {
                if (data) {
                    homeAssistantSwitch7Info = data;
                    homeAssistantScreen.switch7R.switch7.state = JSON.parse(homeAssistantSwitch7Info)['state'];
                } else {
                    homeAssistantSwitch7Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch8, function(data) {
                if (data) {
                    homeAssistantSwitch8Info = data;
                    homeAssistantScreen.switch8R.switch8.state = JSON.parse(homeAssistantSwitch8Info)['state'];
                } else {
                    homeAssistantSwitch8Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch9, function(data) {
                if (data) {
                    homeAssistantSwitch9Info = data;
                    homeAssistantScreen.switch9R.switch9.state = JSON.parse(homeAssistantSwitch9Info)['state'];
                } else {
                    homeAssistantSwitch9Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch10, function(data) {
                if (data) {
                    homeAssistantSwitch10Info = data;
                    homeAssistantScreen.switch10R.switch10.state = JSON.parse(homeAssistantSwitch10Info)['state'];
                } else {
                    homeAssistantSwitch10Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch11, function(data) {
                if (data) {
                    homeAssistantSwitch11Info = data;
                    homeAssistantScreen.switch11R.switch11.state = JSON.parse(homeAssistantSwitch11Info)['state'];
                } else {
                    homeAssistantSwitch11Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch12, function(data) {
                if (data) {
                    homeAssistantSwitch12Info = data;
                    homeAssistantScreen.switch12R.switch12.state = JSON.parse(homeAssistantSwitch12Info)['state'];
                } else {
                    homeAssistantSwitch12Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch13, function(data) {
                if (data) {
                    homeAssistantSwitch13Info = data;
                    homeAssistantScreen.switch13R.switch13.state = JSON.parse(homeAssistantSwitch13Info)['state'];
                } else {
                    homeAssistantSwitch13Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch14, function(data) {
                if (data) {
                    homeAssistantSwitch14Info = data;
                    homeAssistantScreen.switch14R.switch14.state = JSON.parse(homeAssistantSwitch14Info)['state'];
                } else {
                    homeAssistantSwitch14Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch15, function(data) {
                if (data) {
                    homeAssistantSwitch15Info = data;
                    homeAssistantScreen.switch15R.switch15.state = JSON.parse(homeAssistantSwitch15Info)['state'];
                } else {
                    homeAssistantSwitch15Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch16, function(data) {
                if (data) {
                    homeAssistantSwitch16Info = data;
                    homeAssistantScreen.switch16R.switch16.state = JSON.parse(homeAssistantSwitch16Info)['state'];
                } else {
                    homeAssistantSwitch16Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch17, function(data) {
                if (data) {
                    homeAssistantSwitch17Info = data;
                    homeAssistantScreen.switch17R.switch17.state = JSON.parse(homeAssistantSwitch17Info)['state'];
                } else {
                    homeAssistantSwitch17Info = "";
                }
            });

            getHomeAssistant(homeAssistantSwitch18, function(data) {
                if (data) {
                    homeAssistantSwitch18Info = data;
                    homeAssistantScreen.switch18R.switch18.state = JSON.parse(homeAssistantSwitch18Info)['state'];
                } else {
                    homeAssistantSwitch18Info = "";
                }
            });
        }
    }
    ...
    function readDefaults() {
        ...
        homeAssistantSwitch1 = homeAssistantSwitchesJson ['Switch6'];
        homeAssistantSwitch2 = homeAssistantSwitchesJson ['Switch7'];
        homeAssistantSwitch3 = homeAssistantSwitchesJson ['Switch8'];
        homeAssistantSwitch4 = homeAssistantSwitchesJson ['Switch9'];
        homeAssistantSwitch5 = homeAssistantSwitchesJson ['Switch10'];
        homeAssistantSwitch1 = homeAssistantSwitchesJson ['Switch11'];
        homeAssistantSwitch2 = homeAssistantSwitchesJson ['Switch12'];
        homeAssistantSwitch3 = homeAssistantSwitchesJson ['Switch13'];
        homeAssistantSwitch4 = homeAssistantSwitchesJson ['Switch14'];
        homeAssistantSwitch5 = homeAssistantSwitchesJson ['Switch15'];
        homeAssistantSwitch1 = homeAssistantSwitchesJson ['Switch16'];
        homeAssistantSwitch2 = homeAssistantSwitchesJson ['Switch17'];
        homeAssistantSwitch3 = homeAssistantSwitchesJson ['Switch18'];
